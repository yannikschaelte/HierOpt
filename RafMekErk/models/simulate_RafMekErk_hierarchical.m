...
% USAGE:
% ======
% [...] = simulate_RafMekErk_hierarchical(tout,theta)
% [...] = simulate_RafMekErk_hierarchical(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_RafMekErk_hierarchical(...)
%
% INPUTS:
% =======
...
function varargout = simulate_RafMekErk_hierarchical(varargin)
...
sol = ami_RafMekErk_hierarchical(tout,theta(1:12),kappa(1:2),options_ami,plist,pbar(plist+1),xscale,init,data);
if(nargout>1)
