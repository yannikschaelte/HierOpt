% simulate_BachmannJakStat_SHP1oe.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_BachmannJakStat_SHP1oe(tout,theta)
% [...] = simulate_BachmannJakStat_SHP1oe(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_BachmannJakStat_SHP1oe(...)
%
% INPUTS:
% =======
...
function varargout = simulate_BachmannJakStat_SHP1oe(varargin)
...
sol = ami_BachmannJakStat_SHP1oe(tout,theta(1:27),kappa(1:5),options_ami,plist,pbar(plist+1),xscale,init,data);
if(nargout>1)
