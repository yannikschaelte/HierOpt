% simulate_RafMekErk_hierarchical_adjoint2.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_RafMekErk_hierarchical_adjoint2(tout,theta)
% [...] = simulate_RafMekErk_hierarchical_adjoint2(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_RafMekErk_hierarchical_adjoint2(...)
%
% INPUTS:
% =======
...
function varargout = simulate_RafMekErk_hierarchical_adjoint2(varargin)
...
sol = ami_RafMekErk_hierarchical_adjoint2(tout,theta(1:12),kappa(1:10),options_ami,plist,pbar(plist+1),xscale,init,data);
if(nargout>1)
