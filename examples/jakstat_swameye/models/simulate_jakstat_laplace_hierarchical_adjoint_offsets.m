% simulate_jakstat_laplace_hierarchical_adjoint_offsets.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_jakstat_laplace_hierarchical_adjoint_offsets(tout,theta)
% [...] = simulate_jakstat_laplace_hierarchical_adjoint_offsets(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_jakstat_laplace_hierarchical_adjoint_offsets(...)
%
% INPUTS:
% =======
...
function varargout = simulate_jakstat_laplace_hierarchical_adjoint_offsets(varargin)
...
sol = ami_jakstat_laplace_hierarchical_adjoint_offsets(tout,theta(1:10),kappa(1:6),options_ami,plist,xscale,init,data);
if(nargout>1)
