% simulate_jakstat_laplace_standard.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_jakstat_laplace_standard(tout,theta)
% [...] = simulate_jakstat_laplace_standard(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_jakstat_laplace_standard(...)
%
% INPUTS:
% =======
...
function varargout = simulate_jakstat_laplace_standard(varargin)
...
sol = ami_jakstat_laplace_standard(tout,theta(1:17),kappa(1:2),options_ami,plist,xscale,init,data);
if(nargout>1)
