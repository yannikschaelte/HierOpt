% simulate_BachmannJakStat.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_BachmannJakStat(tout,theta)
% [...] = simulate_BachmannJakStat(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_BachmannJakStat(...)
%
% INPUTS:
% =======
...
function varargout = simulate_BachmannJakStat(varargin)
...
sol = ami_BachmannJakStat(tout,theta(1:27),kappa(1:5),options_ami,plist,pbar(plist+1),xscale,init,data);
if(nargout>1)
