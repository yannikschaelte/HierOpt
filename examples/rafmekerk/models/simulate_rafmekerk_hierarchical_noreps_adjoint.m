...
% USAGE:
% ======
% [...] = simulate_rafmekerk_hierarchical_noreps_adjoint(tout,theta)
% [...] = simulate_rafmekerk_hierarchical_noreps_adjoint(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_rafmekerk_hierarchical_noreps_adjoint(...)
%
% INPUTS:
% =======
...
function varargout = simulate_rafmekerk_hierarchical_noreps_adjoint(varargin)
...
sol = ami_rafmekerk_hierarchical_noreps_adjoint(tout,theta(1:12),kappa(1:10),options_ami,plist,xscale,init,data);
if(nargout>1)
