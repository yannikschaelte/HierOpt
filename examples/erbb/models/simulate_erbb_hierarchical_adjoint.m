% simulate_erbb_hierarchical_adjoint.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_erbb_hierarchical_adjoint(tout,theta)
% [...] = simulate_erbb_hierarchical_adjoint(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_erbb_hierarchical_adjoint(...)
%
% INPUTS:
% =======
...
function varargout = simulate_erbb_hierarchical_adjoint(varargin)
...
sol = ami_erbb_hierarchical_adjoint(tout,theta(1:216),kappa(1:7),options_ami,plist,xscale,init,data);
if(nargout>1)
