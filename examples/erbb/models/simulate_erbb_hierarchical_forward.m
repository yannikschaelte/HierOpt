% simulate_erbb_hierarchical_forward.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_erbb_hierarchical_forward(tout,theta)
% [...] = simulate_erbb_hierarchical_forward(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_erbb_hierarchical_forward(...)
%
% INPUTS:
% =======
...
function varargout = simulate_erbb_hierarchical_forward(varargin)
...
if(max(options_ami.sens_ind)>216)
...
sol = ami_erbb_hierarchical_forward(tout,theta(1:216),kappa(1:4),options_ami,plist,xscale,init,data);
if(nargout>1)
