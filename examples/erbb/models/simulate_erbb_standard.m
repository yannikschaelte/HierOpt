% simulate_erbb_standard.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_erbb_standard(tout,theta)
% [...] = simulate_erbb_standard(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_erbb_standard(...)
%
% INPUTS:
% =======
...
function varargout = simulate_erbb_standard(varargin)
...
if(max(options_ami.sens_ind)>219)
...
sol = ami_erbb_standard(tout,theta(1:219),kappa(1:4),options_ami,plist,xscale,init,data);
if(nargout>1)
