...
%   this routine was generated using AMICI commit b5f3f060258bbe3f7224fe63413d0968cbb2aa1c in branch feature_scalings in repo .
%
% USAGE:
% ======
% [...] = simulate_JakStat_hierarchical(tout,theta)
% [...] = simulate_JakStat_hierarchical(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_JakStat_hierarchical(...)
%
% INPUTS:
% =======
...
function varargout = simulate_JakStat_hierarchical(varargin)
...
sol = ami_JakStat_hierarchical(tout,theta(1:11),kappa(1:3),options_ami,plist,pbar(plist+1),xscale,init,data);
if(nargout>1)
